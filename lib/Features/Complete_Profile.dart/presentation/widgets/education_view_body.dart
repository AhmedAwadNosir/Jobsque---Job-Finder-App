...
import 'package:jobsque_jobfinder/Features/Complete_Profile.dart/presentation/widgets/education_button_bloc_consumer.dart';
...
class _EducationViewBodyState extends State<EducationViewBody> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocBuilder<FetchProfileDataCubit, FetchProfileDataState>(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomTextFieldSection(
                          ...
                          onSubmited: (value) {
                            setState(() {
                              value != ""
                                  ? education = value
                                  : education = state is FetchProfileDataSuccess
                                      ? state.profileDataModel.education
                                      : "";
                            });
                          },
                          onChanged: (value) {
                        ...
                        const SizedBox(height: 32),
                        EducationButtonBlocConsumer(education: education)
                      ],
                    ),
                  ),
                ),
